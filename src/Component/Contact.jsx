            ...
            <div id="text" className='wow animate__animated animate__bounceIn'>
              ...
              <div id='shy'>
                ...
                <div className='shy_div-1'>
                  ...
                  <div id='shy_text'>
                    <h4>MAIL ME</h4>
                    <h4 style={{ fontWeight: "300", marginTop: "8px", lineHeight: "1.5" }}>komalgodhaniya1@gmail.com</h4>
                  </div>
                </div>
                <br />
                <div className='shy_div-1'>
                  ...
                  <div id='shy_text'>
                    <h4>CALL ME</h4>
                    <h4 style={{ fontWeight: "300", marginTop: "8px", lineHeight: "1.5" }}>+91 9601775380</h4>
                  </div>
                </div>
              </div>
            </div>
